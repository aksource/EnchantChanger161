...
public class EntityWeaponOrb extends Entity
{
	/**
	...
	/** This is how much WeaponXP this orb has. */
	private int wxpValue;
	...
	public EntityWeaponOrb(World par1World, double par2, double par4, double par6, int par8)
	{
		super(par1World);
	...
	public EntityWeaponOrb(World par1World)
	{
		super(par1World);
	...
	public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		par1NBTTagCompound.setShort("Value", (short)this.wxpValue);
	}
	...
	public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		this.wxpValue = par1NBTTagCompound.getShort("Value");
	}
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
	{
		if (!this.worldObj.isRemote)
		{
			if (this.field_70532_c == 0 && par1EntityPlayer.xpCooldown == 0)
			{
				...
				if(par1EntityPlayer.getHeldItem().getItem() instanceof ItemLevelUpWeapons)
					((ItemLevelUpWeapons)par1EntityPlayer.getHeldItem().getItem()).addWeaponPoints(wxpValue);
				this.setDead();
			}
		}
	}
	...
	{
		return this.wxpValue >= 2477 ? 10 : (this.wxpValue >= 1237 ? 9 : (this.wxpValue >= 617 ? 8 : (this.wxpValue >= 307 ? 7 : (this.wxpValue >= 149 ? 6 : (this.wxpValue >= 73 ? 5 : (this.wxpValue >= 37 ? 4 : (this.wxpValue >= 17 ? 3 : (this.wxpValue >= 7 ? 2 : (this.wxpValue >= 3 ? 1 : 0)))))))));
	}
