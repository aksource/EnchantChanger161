...
//		texturemanager.bindTexture(res);
		...
		GL11.glRotatef(par1EntityMissile.prevRotationPitch + (par1EntityMissile.rotationPitch - par1EntityMissile.prevRotationPitch) * par9, 0.0F, 0.0F, 1.0F);
...
//		float f11 = (float)par1EntityMissile.arrowShake - par9;
//
//		if (f11 > 0.0F)
//		{
...
//		}
	...
	{
		this.renderMissile((EntityMissile)par1Entity, par2, par4, par6, par8, par9);
	}
