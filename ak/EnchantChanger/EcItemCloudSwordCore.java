	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		if(par3EntityPlayer.isSneaking()){
			if (par2World.isRemote) {
				...
				ObfuscationReflectionHelper.setPrivateValue(ItemSword.class, (ItemSword)par1ItemStack.getItem(), (float)((ActiveMode)?7:6), 0);
...
//							EnchantmentThorns.func_92096_a(player, (EntityLiving)par1Entity, player.worldObj.rand);
//						}
//					}
//
