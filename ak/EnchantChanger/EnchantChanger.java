...
public class EnchantChanger {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		ItemExExpBottle = new EcItemExExpBottle(ExExpBottleID - 256)
		...
		ItemSephirothSword = (new EcItemSephirothSword(
				SephirothSwordItemID - 256)).setUnlocalizedName(
		...
		ItemUltimateWeapon = (new EcItemUltimateWeapon(
				UltimateWeaponItemID - 256)).setUnlocalizedName(
		...
		ItemPortableEnchantChanger = (new EcItemMaterializer(
				PortableEnchantChangerID - 256)).setUnlocalizedName(
		...
		ItemPortableEnchantmentTable = (new EcItemEnchantmentTable(
				PortableEnchantmentTableID - 256)).setUnlocalizedName(
		...
		MasterMateria = new EcItemMasterMateria(MasterMateriaID - 256)
		...
		ItemImitateSephirothSword = (new EcItemSephirothSwordImit(
				ImitateSephSwordID - 256)).setUnlocalizedName(
		...
		BlockMat = (new EcBlockMaterialize(EnchantChangerID)).setCreativeTab(
				tabsEChanger).setUnlocalizedName("EnchantChanger");
		GameRegistry.registerBlock(BlockMat, "EnchantChanger");
		HugeMateria = new EcBlockHugeMateria(HugeMateriaID)
				.setUnlocalizedName("HugeMateria");
		GameRegistry.registerBlock(HugeMateria, "blockhugemateria");
		ItemHugeMateria = new EcItemHugeMateria(HugeMateria.blockID - 256)
	...
	public void load(FMLInitializationEvent event) {
		...
		if (this.Difficulty < 2)
			...
			GameRegistry.addRecipe(
					...
					new Object[] { " X ", "DYD", " Z ", Character.valueOf('X'),
							Block.blockIron, Character.valueOf('Y'),
							new ItemStack(ItemMat, 1, 0),
							Character.valueOf('Z'), Item.ingotIron, 'D',
							Item.diamond });
		GameRegistry.addRecipe(
				new ItemStack(ItemSephirothSword, 1),
				new Object[] { "  A", " B ", "C  ", Character.valueOf('A'),
						Item.ingotIron, Character.valueOf('B'),
		...
		GameRegistry.addRecipe(new ItemStack(ItemImitateSephirothSword), "  A",
				" A ", "B  ", 'A', Item.ingotIron, 'B', Item.swordIron);
		GameRegistry.addRecipe(new ItemStack(BlockMat, 1),
				new Object[] { "XYX", "ZZZ", Character.valueOf('X'),
						Item.diamond, Character.valueOf('Y'), Block.blockGold,
						Character.valueOf('Z'), Block.obsidian });
		GameRegistry.addRecipe(new ItemStack(HugeMateria), new Object[] {
				" A ", "ABA", " A ", 'A', Block.blockDiamond, 'B',
				Item.netherStar });
		GameRegistry
		...
		GameRegistry.addShapelessRecipe(new ItemStack(
				...
				new Object[] { Block.enchantmentTable });
		...
		if (this.Difficulty == 0)
			GameRegistry.addRecipe(
					new ItemStack(Item.expBottle, 8),
		...
		GameRegistry.addRecipe(new ItemStack(ItemExExpBottle, 8), new Object[] {
				...
				new ItemStack(Item.expBottle, 1, 0), Character.valueOf('Y'),
				new ItemStack(Block.blockDiamond, 1) });
		GameRegistry
				.addRecipe(new ItemStack(Block.dragonEgg, 1), new Object[] {
						"XXX",
						"XYX",
						"XXX",
						Character.valueOf('X'),
