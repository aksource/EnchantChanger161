...
public class plItemMobegg extends ItemMonsterPlacer
{
			...
			else
			{
				...
				else
				{
					if (movingobjectposition.typeOfHit == EnumMovingObjectType.ENTITY)
					{
						...
						{
							if(this.func_111207_a(par1ItemStack, par3EntityPlayer, (EntityLivingBase) entity))
								return null;
							else
								return par1ItemStack;
						}
	...
	{
		this.func_111207_a(par1ItemStack, (EntityPlayer) par3EntityLivingBase, par2EntityLivingBase);
		return true;
	}
