...
{
	public ItemSoupStack(int par1, int par2)
	{
	...
	public ItemStack onEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		...
		return mod_StackSizeChange.addropItems(par1ItemStack, par3EntityPlayer, new ItemStack(Item.bowlEmpty), false);
	}
	...
	public void onEntityInteractEvent(EntityInteractEvent event)
	{
		...
		{
			ItemStack result = mod_StackSizeChange.addropItems(itemstack, event.entityPlayer, new ItemStack(Item.bowlSoup), true, true);
