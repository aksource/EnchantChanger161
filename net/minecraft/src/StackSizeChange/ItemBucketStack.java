...
public class ItemBucketStack extends ItemBucket
{
	...
	public ItemBucketStack(int par1, int par2)
	{
		...
		this.func_111206_d(par1 == 69 ?"bucket_empty": par1 == 70 ? "bucket_water":"bucket_lava");
	}
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		...
		else
		{
			...
			{
				return mod_StackSizeChange.addropItems(par1ItemStack, par3EntityPlayer, event.result);
			}
...
//						par2World.setBlockWithNotify(var13, var14, var15, 0);
						...
						return mod_StackSizeChange.addropItems(par1ItemStack, par3EntityPlayer, new ItemStack(mod_StackSizeChange.bucketWater));
					}
...
//						par2World.setBlockWithNotify(var13, var14, var15, 0);
						par2World.setBlockToAir(var13, var14, var15);
						return mod_StackSizeChange.addropItems(par1ItemStack, par3EntityPlayer, new ItemStack(mod_StackSizeChange.bucketLava));
					}
				}
				else
				{
	...
	public boolean tryPlaceContainedLiquid(World par1World, double par2, double par4, double par6, int par8, int par9, int par10)
	{
		...
		{
			if (par1World.provider.isHellWorld && this.isFull == Block.waterMoving.blockID && mod_StackSizeChange.isNetherSetWater)
			{
