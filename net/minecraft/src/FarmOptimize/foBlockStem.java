...
public class foBlockStem extends BlockStem
{
    ...
    public foBlockStem(int par1, Block par2Block)
    {
        super(par1, par2Block);
        this.func_111022_d(par1 == 104 ?"pumpkin_stem":"melon_stem");
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 9)
        {
			...
			int speed = (blockID == Block.pumpkinStem.blockID ? mod_FarmOptimize.growSpeedPunpkin : 
				blockID == Block.melonStem.blockID ? mod_FarmOptimize.growSpeedWaterMelon : 100);
