...
public class foBlockCarrot extends BlockCarrot
{
    public foBlockCarrot(int par1)
    {
        super(par1);
        this.func_111022_d("carrots");
    }

    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        super.checkFlowerChange(par1World, par2, par3, par4);
        ...
        if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 9)
        {
            ...
            if (var6 < 7)
            {
		        ...
		        {
		            case 59:
		                 speed = mod_FarmOptimize.growSpeedCrops; break;
		            case 141:
		                 speed = mod_FarmOptimize.growSpeedCarrot; break;
		            case 142:
		                 speed = mod_FarmOptimize.growSpeedPotato; break;
		            default:
		                 speed = 100;
		        }
