...
{
    public foBlockVine(int par1)
    {
        super(par1);
        this.func_111022_d("vine");
    }
    ...
    {
		if(mod_FarmOptimize.growSpeedVine == -1) return;
		
        if (!par1World.isRemote && (mod_FarmOptimize.growSpeedVine == 0 
			|| par1World.rand.nextInt(mod_FarmOptimize.growSpeedVine) == 0))
        {
            byte var6 = 4;
            int var7 = 5;
            boolean var8 = false;
