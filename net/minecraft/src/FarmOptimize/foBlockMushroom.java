...
{
    public foBlockMushroom(int par1, String par2Str)
    {
        //super(par1, par2Str);
        super(par1);
        this.func_111022_d("mushroom_block");
    }

    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        if (mod_FarmOptimize.MushroomSpeed == 0 
			|| par5Random.nextInt(mod_FarmOptimize.MushroomSpeed) == 0)
        {
            byte var6 = mod_FarmOptimize.MushroomArea;
            int var7 = mod_FarmOptimize.MushroomLimit;
            int var8;
            int var9;
            int var10;
