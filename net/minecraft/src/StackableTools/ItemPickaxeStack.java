...
{
	public ItemPickaxeStack(int par1, EnumToolMaterial par2EnumToolMaterial)
	{
		super(par1, par2EnumToolMaterial);
		this.setMaxStackSize(mod_StackableTools.PickaxeMax);
		this.setHasSubtypes(true);
		setUnlocalizedName("pickaxe" + ItemSwordStack.toolMaterialNames[par2EnumToolMaterial.ordinal()]);
		this.func_111206_d(ItemSwordStack.toolMaterialNames[par2EnumToolMaterial.ordinal()].toLowerCase() + "_pickaxe");
	}
