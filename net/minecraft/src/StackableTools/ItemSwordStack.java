...
public class ItemSwordStack extends ItemSword
{
	...
	public ItemSwordStack(int par1, EnumToolMaterial par2EnumToolMaterial)
	{
		...
		this.setMaxStackSize(mod_StackableTools.SwordMax);
		...
		this.func_111206_d(ItemSwordStack.toolMaterialNames[par2EnumToolMaterial.ordinal()].toLowerCase() + "_sword");
	}
	...
	public boolean onBlockDestroyed(ItemStack par1ItemStack, World par2World, int par3, int par4, int par5, int par6, EntityLiving par7EntityLiving)
	{
		...
		{	
			...
			{
				par1ItemStack.damageItem(mod_StackableTools.WebDamage, par7EntityLiving);
			}
			else
			{
