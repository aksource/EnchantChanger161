...
public class ItemUQAsmoSlasher extends ItemUniqueArms
{
    ...
    public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase)
    {
		...
		{
			((EntityCreeper)par2EntityLivingBase).getDataWatcher().updateObject(17, Byte.valueOf((byte)1));
		}

		if (par2EntityLivingBase instanceof EntityPig)
		{
			((EntityPig)par2EntityLivingBase).onStruckByLightning((EntityLightningBolt)null);
		}
